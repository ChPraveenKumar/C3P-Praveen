...
public class SearchRequestServiceWithVersion implements Observer {
	...
	try {
		...
		try {
		    ...
		    String requestType = value.substring(0,
    ...
    /*
   	 * Owner: Rahul Tiwari Module: TestAndDiagnosis Logic: Get all the test name with version
   	 * custom tests
   	 */
   	@POST
   	...
   	public Response getTestAndDiagnosisDetailsDuplicateLatest(@RequestBody String testDetails)
   		...
   		try {
   			...
   			for (String testName : splitTestAndDiagnosis) {
   				...
   				// Logic for getting test name and version and append testName into builderTestName and version into builderVersion
   	...
   	/*
   	 * Owner: Rahul Tiwari Module: Request Details Logic: Get all the configuration feature based on request Id and template Id
   	 * custom tests
   	 */
   	@POST
   	...
   	/*
   	 * Owner: Rahul Tiwari Module: Request Details Logic: Get configuration
   	 * feature details based on requestId, requestId, temaplate Id and feature custom tests
   	 */
   	@POST
   	...
   	@ResponseBody
   	public Response getConfigurationFeatureDetails(
   		...
   		try {
   			...
   			// parse requestDetails and get requestId, templateId, and feature from requestDetails
   			json = (JSONObject) parser.parse(requestDetails);
   			requestId = (String) json.get("requestId");
   			templateId = (String) json.get("templateId");
   			...
   			configFeatureList = dao.getConfigurationFeatureDetails(requestId,
   					templateId, feature);
