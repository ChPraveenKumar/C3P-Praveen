...
@Entity
@Table(name="c3p_t_ds_import_history")
public class ImportStagingHistory{
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "ih_row_id", length = 11)
	private int rowId;
	
	@Column(name = "ih_seq_id", length = 16)
	private int seqId;
	
	@Column(name = "ih_row_status", length = 5)
	private String rowStatus;
	
	@Column(name = "ih_row_error_code", length = 25)
	private String rowErrorCode;
	
	@Column(name = "ih_import_id", length = 30)
	private String importId;
	
	@Column(name = "ih_seq_1", length = 255)
	private String seq_1;
	
	@Column(name = "ih_seq_2", length = 255)
	private String seq_2;
	
	@Column(name = "ih_seq_3", length = 255)
	private String seq_3;
	
	@Column(name = "ih_seq_4", length = 255)
	private String seq_4;
	
	@Column(name = "ih_seq_5", length = 255)
	private String seq_5;
	
	@Column(name = "ih_seq_6", length = 255)
	private String seq_6;
	
	@Column(name = "ih_seq_7", length = 255)
	private String seq_7;
	
	@Column(name = "ih_seq_8", length = 255)
	private String seq_8;
	
	@Column(name = "ih_seq_9", length = 255)
	private String seq_9;
	
	@Column(name = "ih_seq_10", length = 255)
	private String seq_10;
	
	@Column(name = "ih_seq_11", length = 255)
	private String seq_11;
	
	@Column(name = "ih_seq_12", length = 255)
	private String seq_12;
	
	@Column(name = "ih_seq_13", length = 255)
	private String seq_13;
	
	@Column(name = "ih_seq_14", length = 255)
	private String seq_14;
	
	@Column(name = "ih_seq_15", length = 255)
	private String seq_15;
	
	@Column(name = "ih_seq_16", length = 255)
	private String seq_16;
	
	@Column(name = "ih_seq_17", length = 255)
	private String seq_17;
	
	@Column(name = "ih_seq_18", length = 255)
	private String seq_18;
	
	@Column(name = "ih_seq_19", length = 255)
	private String seq_19;
	
	@Column(name = "ih_seq_20", length = 255)
	private String seq_20;
	
	@Column(name = "ih_seq_21", length = 255)
	private String seq_21;
	
	@Column(name = "ih_seq_22", length = 255)
	private String seq_22;
	
	@Column(name = "ih_seq_23", length = 255)
	private String seq_23;
	
	@Column(name = "ih_seq_24", length = 255)
	private String seq_24;

	@Column(name = "ih_seq_25", length = 255)
	private String seq_25;
	
	@Column(name = "ih_seq_26", length = 255)
	private String seq_26;
	
	@Column(name = "ih_seq_27", length = 255)
	private String seq_27;
	
	@Column(name = "ih_seq_28", length = 255)
	private String seq_28;
	
	@Column(name = "ih_seq_29", length = 255)
	private String seq_29;
	
	@Column(name = "ih_seq_30", length = 255)
	private String seq_30;
	
	@Column(name = "ih_seq_31", length = 255)
	private String seq_31;
	
	@Column(name = "ih_seq_32", length = 255)
	private String seq_32;
	
	@Column(name = "ih_seq_33", length = 255)
	private String seq_33;
	
	@Column(name = "ih_seq_34", length = 255)
	private String seq_34;
	
	@Column(name = "ih_seq_35", length = 255)
	private String seq_35;
	
	@Column(name = "ih_seq_36", length = 255)
	private String seq_36;
	
	@Column(name = "ih_seq_37", length = 255)
	private String seq_37;
	
	@Column(name = "ih_seq_38", length = 255)
	private String seq_38;
	
	@Column(name = "ih_seq_39", length = 255)
	private String seq_39;
	
	@Column(name = "ih_seq_40", length = 255)
	private String seq_40;
	
	@Column(name = "ih_seq_41", length = 255)
	private String seq_41;
	
	@Column(name = "ih_seq_42", length = 255)
	private String seq_42;
	
	@Column(name = "ih_seq_43", length = 255)
	private String seq_43;
	
	@Column(name = "ih_seq_44", length = 255)
	private String seq_44;
	
	@Column(name = "ih_seq_45", length = 255)
	private String seq_45;
	
	@Column(name = "ih_seq_46", length = 255)
	private String seq_46;
	
	@Column(name = "ih_seq_47", length = 255)
	private String seq_47;
	
	@Column(name = "ih_seq_48", length = 255)
	private String seq_48;
	
	@Column(name = "ih_seq_49", length = 255)
	private String seq_49;
	
	@Column(name = "ih_seq_50", length = 255)
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ImportStagingHistory other = (ImportStagingHistory) obj;
