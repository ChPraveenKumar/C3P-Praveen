...
public class RequestInfoSO {
	...
	public String toString() {
		return "RequestInfoSO [release=" + release + ", banner=" + banner + ", deviceName=" + deviceName + ", model="
				+ model + ", region=" + region + ", service=" + service + ", version=" + version + ", hostname="
				+ hostname + ", secret=" + secret + ", vrf=" + vrf + ", isAutoProgress=" + isAutoProgress
				+ ", internetLcVrf=" + internetLcVrf + ", misArPeSO=" + misArPeSO + ", deviceInterfaceSO="
				+ deviceInterfaceSO + "]";
	}
