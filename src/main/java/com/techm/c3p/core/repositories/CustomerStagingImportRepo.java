...
public interface CustomerStagingImportRepo extends JpaRepository<CustomerStagingEntity, Integer> {
	...
	@Query("SELECT new com.techm.c3p.core.entitybeans.CustomerStagingEntity (hostname,iPV4ManagementAddress, result, outcomeResult,"
	...
	@Query("SELECT new com.techm.c3p.core.entitybeans.CustomerStagingEntity (stagingId, hostname, deviceVendor,deviceFamily, deviceModel, os, "
