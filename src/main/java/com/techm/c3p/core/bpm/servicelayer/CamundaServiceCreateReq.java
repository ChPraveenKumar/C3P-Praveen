...
public class CamundaServiceCreateReq {
	...
	@SuppressWarnings("unchecked")
	public void uploadToServerNewForApproval(String requestId, String version, String requestType)
			throws IOException, JSONException {
		String query = bpmServiceUri + "/engine-rest/process-definition/key/PortReservation/start";
