...
public class InternetLcVrfSO {
	...
	public String toString() {
		return "InternetLcVrf [networkIp=" + networkIp + ", remotePort=" + remotePort + ", neighbor1=" + neighbor1
				+ ", neighbor2=" + neighbor2 + ", neighbor3=" + neighbor3 + ", neighbor4=" + neighbor4 + ", neighbor6="
				+ neighbor6 + ", neighbor5=" + neighbor5 + ", routerBgp65k=" + routerBgp65k + "]";
	}
