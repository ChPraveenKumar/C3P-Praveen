...
public interface MasterFeatureRepository extends JpaRepository<MasterFeatureEntity, Long> {
	...
	public int getCountByFVendorAndFNameAndFOsAndFOsversionAndFRegionAndFNetworkfunAndFFamily(
	...
	public MasterFeatureEntity findByFId(String fId);
	...
	public int updateMasterFeatureStatus(@Param("status") String status, @Param("infoId") String infoId, @Param("version") String version,@Param("comment") String comment, @Param("owner") String owner);
	
	public List<MasterFeatureEntity> findAllByFVendorAndFFamilyAndFOsAndFOsversionAndFRegionAndFNetworkfun(String vendor, String family, String os,String osVersion, String region,
