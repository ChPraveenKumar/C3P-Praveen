...
public interface MasterOIDRepository extends JpaRepository<MasterOIDEntity, Long> {
	...
	@Query(value = "SELECT * FROM c3p_m_oid_master_info where oid_m_category='Interface' oid_m_for_vendor=:oidVendor and oid_m_network_type=:oidNetworkType", nativeQuery = true)
