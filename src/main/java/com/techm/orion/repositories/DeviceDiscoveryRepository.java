...
@Repository
@Transactional
public interface DeviceDiscoveryRepository extends
		JpaRepository<DeviceDiscoveryEntity, Long> {

	List<DeviceDiscoveryEntity> findAllByDVendor(String vendor);

	List<DeviceDiscoveryEntity> findAllByDVendorAndDModel(String vendor,
			String model);

	List<DeviceDiscoveryEntity> findAllByDVendorAndDModelAndDHostName(
			String model, String vendor, String hostname);
	...
	List<DeviceDiscoveryEntity> findAllByDVendorAndUsersUserName(String vendor,
			String user);

	List<DeviceDiscoveryEntity> findAllByDVendorAndDModelAndUsersUserName(
			String vendor, String model, String user);

	List<DeviceDiscoveryEntity> findAllByDVendorAndDModelAndDHostNameAndUsersUserName(
			String vendor, String model, String hostName, String user);

	List<DeviceDiscoveryEntity> findAllByCustSiteIdCCustNameAndUsersUserName(
	...
	List<DeviceDiscoveryEntity> findAllByCustSiteIdCCustNameAndCustSiteIdCSiteRegion(
	...
	List<DeviceDiscoveryEntity> findByDHostNameContainingAndCustSiteIdCCustName(
			String hostname, String customername);

	List<DeviceDiscoveryEntity> findByDHostNameContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegion(
			String hostname, String customername, String region);
	...
	List<DeviceDiscoveryEntity> findByDMgmtIpContainingAndCustSiteIdCCustName(
			String managementip, String customername);
	...
	List<DeviceDiscoveryEntity> findBydOsContainingAndCustSiteIdCCustName(
			String os, String customername);

	List<DeviceDiscoveryEntity> findBydOsContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegion(
			String os, String customername, String region);
	...
	List<DeviceDiscoveryEntity> findBydOsVersionContainingAndCustSiteIdCCustName(
			String osversion, String customername);
	...
	List<DeviceDiscoveryEntity> findByDModelContainingAndCustSiteIdCCustName(
			String model, String customername);

	List<DeviceDiscoveryEntity> findByDModelContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegion(
			String model, String customername, String region);
	...
	List<DeviceDiscoveryEntity> findBydTypeContainingAndCustSiteIdCCustName(
			String devicetype, String customername);

	List<DeviceDiscoveryEntity> findBydTypeContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegion(
			String devicetype, String customername, String region);
	...
	List<DeviceDiscoveryEntity> findBydEndOfSaleDateContainingAndCustSiteIdCCustName(
			String eol, String customername);

	List<DeviceDiscoveryEntity> findBydEndOfSaleDateContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegion(
			String eol, String customername, String region);
	...
	List<DeviceDiscoveryEntity> findBydEndOfSupportDateContainingAndCustSiteIdCCustName(
			String eos, String customername);
	...
	List<DeviceDiscoveryEntity> findByCustSiteIdCCustNameAndCustSiteIdCSiteRegion(
			String customername, String region);
	...
	List<DeviceDiscoveryEntity> findByDHostNameAndDMgmtIp(String tempHostName,
			String tempManagementIp);
	...
	DeviceDiscoveryEntity findHostNameAndMgmtip(@Param("mgmtip") String mgmtip,
	...
	int updateDescripancyId(@Param("resultDevice") int resultDevice,
	...
	@Modifying
	@Transactional
	List<DeviceDiscoveryEntity> findAllDevices(String vendor,
			String deviceFamily, String osVersion);
	...
	@Modifying
	@Transactional
	List<DeviceDiscoveryEntity> findByVendorFamilyVersionCustomer(
			String vendor, String deviceFamily, String osVersion,
			String customer);
	...
	@Modifying
	@Transactional
	List<DeviceDiscoveryEntity> findByVendorFamilyVersionCustomerRegion(
			String vendor, String deviceFamily, String osVersion,
	...
	@Modifying
	@Transactional
	List<DeviceDiscoveryEntity> findByVendorFamilyVersionCustomerRegionSite(
			String vendor, String deviceFamily, String osVersion,
