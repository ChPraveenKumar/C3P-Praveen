...
public interface DeviceDiscoveryRepository extends JpaRepository<DeviceDiscoveryEntity, Long> {
	...
	List<DeviceDiscoveryEntity> findByCustSiteIdCCustNameAndCustSiteIdCSiteRegionAndCustSiteIdCSiteName(String customername,String region,String sitename);
...
//	List<DeviceDiscoveryEntity> findByTop(String model,String vendor);
	List<DeviceDiscoveryEntity> findByDHostNameAndDMgmtIp(
			String tempHostName, String tempManagementIp);
