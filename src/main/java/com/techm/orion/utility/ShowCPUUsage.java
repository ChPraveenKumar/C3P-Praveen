...
public class ShowCPUUsage {
	...
	public String cpuUsageInfo(String ip, String username, String password,String routername, String region,String type) throws IOException
	{
		String result=null;
		ShowCPUUsage.loadProperties();
		String port = ShowCPUUsage.PROPERTIES
				.getProperty("portSSH");
		try {
			JSch jsch = new JSch();
			...
			result=printCPUUsageInfo(input, channel,
					routername,
					region,type);
	...
	public int getCPUUsagePercentage(String hostname, String region,String type)
	{
		...
		try {
			...
			{
			filepath = ShowCPUUsage.PROPERTIES
					.getProperty("responseDownloadPathHealthCheckFolder")
					+ "//"+"Pre_"+ hostname
					+ "_" + region + "_CPUusage.txt";
			}
			else
			{
				filepath = ShowCPUUsage.PROPERTIES
	...
	public String printCPUUsageInfo(InputStream input, Channel channel,
