...
public class ShowInventoryTest {
	...
	public String inventoryInfo(String ip, String username, String password,String routername, String region) throws IOException
	{
		String result=null;
		ShowInventoryTest.loadProperties();
		String port = ShowInventoryTest.PROPERTIES
				.getProperty("portSSH");
		try {
			JSch jsch = new JSch();
			...
			printInventoryInfo(input, channel,
					routername,
					region);
	...
	public String printInventoryInfo(InputStream input, Channel channel,
			String routername, String region) throws Exception {
