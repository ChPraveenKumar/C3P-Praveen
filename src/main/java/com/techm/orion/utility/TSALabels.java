...
public enum TSALabels {
	...
	EXTERNAL_MILESTONE_API, EXTERNAL_MILESTONE_NAME, EXTERNAL_MILESTONE_STATUS, EXTERNAL_MILESTONE_SO_ID, EXTERNAL_MILESTONE_API_USERNAME, EXTERNAL_MILESTONE_API_PASSWORD,
	/*Python EndPoints*/
	PYTHON_PING, PYTHON_THROUGHPUT, PYTHON_BACKUP, BACKUP_PORT, IP_MANAGEMENT,PYTHON_SCHEDULER, PYTHON_REPORT,PYTHON_EDIT_NETCONF, PYTHON_TEST_NETCONF,PYTHON_DIFFLIB_DELTA_COMPUTE,PYTHON_DEVICE_DATA,PYTHON_UPDATE_HOST_STATUS,
