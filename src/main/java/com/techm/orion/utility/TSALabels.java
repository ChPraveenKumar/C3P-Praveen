...
public enum TSALabels {
	...
	/*Megham device urls*/
	ODL_GET_CONFIGURATION_URL, ODL_PUT_CONFIGURATION_INTERFACE_URL , ODL_TEST_INTERFACE_MTU , ODL_TEST_ALL_INTERFACE_LIST , ODL_TEST_INTERFACE_ENCAPSULATION , ODL_TEST_INTERFACE_BANDWIDTH, ODL_TEST_NEGOTIATION_TEST, ODL_TEST_BANDWIDTH_TEST;
