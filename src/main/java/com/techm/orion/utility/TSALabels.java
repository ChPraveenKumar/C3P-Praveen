...
public enum TSALabels {
	...
	CONFIGURATION_FILES_XML, VNF_CONFIG_CREATION_PATH, PYTHON_SCRIPT_PATH, STANDARD_CONFIG_PATH, COMPARISON_HTMLS, STATIC_XML_VNF, SNMP_DUMP,
	AJAX_CALL_INTERVAL_FOR_PULL_NOTOFICATION,
	/* User details */
	...
	/* Network Information */
	NETWORK_TEST_COMMAND, NT1, NT2, NT3, NT4, NT5, FILE_CHUNK_SIZE, APP_OS,
