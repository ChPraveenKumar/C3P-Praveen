...
public enum TSALabels {
	...
	/*Python EndPoints*/
	PYTHON_PING, PYTHON_THROUGHPUT, PYTHON_BACKUP, BACKUP_PORT, IP_MANAGEMENT,PYTHON_SCHEDULER, PYTHON_REPORT,PYTHON_EDIT_NETCONF, PYTHON_TEST_NETCONF,PYTHON_DIFFLIB_DELTA_COMPUTE,
