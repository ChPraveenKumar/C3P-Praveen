...
public enum TSALabels {
	...
	AJAX_CALL_INTERVAL_FOR_PULL_NOTOFICATION, PYTHON_SERVICES, COBTemplate, IMAGE_FILE_PATH, FOLDER_SEPARATOR, SOURCE, FW_UPGADE, REQ_SLASHN, REQ_TIME,
	/* User details */
	...
	REGEX_FILTER_PRE_VALIDATION, REGEX_FILTER_PRE_THROUGHPUT, REGEX_FILTER_PRE_FRAMELOSS,REGEX_FILTER_PRE_VALIDATION_OS_VERSION, REGEX_FILTER_FW_MEM,
	/* Spring Information */
	...
	/*Python EndPoints*/
	PYTHON_PING, PYTHON_THROUGHPUT, PYTHON_BACKUP, BACKUP_PORT, IP_MANAGEMENT,PYTHON_SCHEDULER, PYTHON_REPORT,PYTHON_EDIT_NETCONF, PYTHON_TEST_NETCONF,PYTHON_DIFFLIB_DELTA_COMPUTE,PYTHON_DEVICE_DATA,
