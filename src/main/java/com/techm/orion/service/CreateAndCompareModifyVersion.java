...
public class CreateAndCompareModifyVersion {
	...
	public String CompareModifyVersion(String requestIdForConfig,String type) throws Exception{
		...
		List<RequestInfoSO> list=new ArrayList<RequestInfoSO>();
		 ...
		 InvokeFtl invokeFtl=new InvokeFtl();
		    ...
		    if(childVersion.getVrfName()!=null&& parentVersion.getVrfName()!=null&& childVersion.getInternetLcVrf().getNeighbor1_remoteAS()!=null&& parentVersion.getInternetLcVrf().getNeighbor1_remoteAS()!=null)
		    {
		    if(!(childVersion.getVrfName().equalsIgnoreCase(parentVersion.getVrfName()) && 
				    childVersion.getInternetLcVrf().getNeighbor1_remoteAS().equalsIgnoreCase(parentVersion.getInternetLcVrf().getNeighbor1_remoteAS())))
				    {
				    	key="vrf";
				    	//get the data
		    ...
		    if(childVersion.getInternetLcVrf().getRoutingProtocol()!=null&& parentVersion.getInternetLcVrf().getRoutingProtocol()!=null)
		    {
		    if(!(childVersion.getInternetLcVrf().getNeighbor1_remoteAS().equalsIgnoreCase(parentVersion.getInternetLcVrf().getNeighbor1_remoteAS()) && 
		    		childVersion.getVrfName().equalsIgnoreCase(parentVersion.getVrfName())&&
		    		childVersion.getInternetLcVrf().getBgpASNumber().equalsIgnoreCase(parentVersion.getInternetLcVrf().getBgpASNumber())&&
		    		childVersion.getInternetLcVrf().getRoutingProtocol().equalsIgnoreCase(parentVersion.getInternetLcVrf().getRoutingProtocol())&&
		    		childVersion.getInternetLcVrf().getNetworkIp().equalsIgnoreCase(parentVersion.getInternetLcVrf().getNetworkIp())&&
		    		childVersion.getInternetLcVrf().getNetworkIp_subnetMask().equalsIgnoreCase(parentVersion.getInternetLcVrf().getNetworkIp_subnetMask())&&
		    		childVersion.getInternetLcVrf().getNeighbor1().equalsIgnoreCase(parentVersion.getInternetLcVrf().getNeighbor1())
		    		/*childVersion.getInternetLcVrf().getNeighbor2().equalsIgnoreCase(parentVersion.getInternetLcVrf().getNeighbor2())&&
		    		childVersion.getInternetLcVrf().getNeighbor2_remoteAS().equalsIgnoreCase(parentVersion.getInternetLcVrf().getNeighbor2_remoteAS())
		    		*/
		    		))
		    		{
		    	key="bgp";
		    ...
		    if(childVersion.getDeviceInterfaceSO().getName()!=null&& parentVersion.getDeviceInterfaceSO().getName()!=null)
		    {
		    if(!(childVersion.getDeviceInterfaceSO().getName().equalsIgnoreCase(parentVersion.getDeviceInterfaceSO().getName()) && 
		    		/*childVersion.getDeviceInterfaceSO().getDescription().equalsIgnoreCase(parentVersion.getDeviceInterfaceSO().getDescription())&*/
		    		childVersion.getDeviceInterfaceSO().getBandwidth().equalsIgnoreCase(parentVersion.getDeviceInterfaceSO().getBandwidth())&&
		    		childVersion.getDeviceInterfaceSO().getEncapsulation().equalsIgnoreCase(parentVersion.getDeviceInterfaceSO().getEncapsulation())
		    		))
		    		{
		    	key="wanInterface";
		    	getConfigDataforNoCmd(parentVersion, key,counter++);
		   ...
		   if(childVersion.getLoopbackIPaddress()!=null&& parentVersion.getLoopbackIPaddress()!=null)
		    ...
		    try {
					...
					TextReport.writeFile(responseDownloadPath, latestVersion.getRequestId()
						+ "V"+latestVersion.getRequest_version()+"_Configuration", response);
					TextReport.writeFile(responseDownloadPath, latestVersion.getRequestId()
							+ "V"+latestVersion.getRequest_version()+"_ConfigurationNoCmd", responseforNoCmd);
	...
	public void createconfigFile(String[] cmd,int counter)
	{
		try{
			...
			public String CompareModifyVersionForTemplate(String requestIdForConfig,String type,CreateConfigRequestDCM configRequest) throws Exception{
				...
				List<RequestInfoSO> list=new ArrayList<RequestInfoSO>();
				 ...
				 InvokeFtl invokeFtl=new InvokeFtl();
				    ...
				    if(configRequest.getVrfName()!=null&& parentVersion.getVrfName()!=null&& configRequest.getNeighbor1_remoteAS()!=null&& parentVersion.getInternetLcVrf().getNeighbor1_remoteAS()!=null)
				    {
				    if(!(configRequest.getVrfName().equalsIgnoreCase(parentVersion.getVrfName()) && 
				    		configRequest.getNeighbor1_remoteAS().equalsIgnoreCase(parentVersion.getInternetLcVrf().getNeighbor1_remoteAS())))
						    {
						    	key="vrf";
						    	//get the data
						    	getConfigDataforNoCmd(parentVersion, key,counter++);
				    ...
				    if(configRequest.getRoutingProtocol()!=null&& parentVersion.getInternetLcVrf().getRoutingProtocol()!=null)
				    {
				    if(!(configRequest.getNeighbor1_remoteAS().equalsIgnoreCase(parentVersion.getInternetLcVrf().getNeighbor1_remoteAS()) && 
				    		configRequest.getVrfName().equalsIgnoreCase(parentVersion.getVrfName())&&
				    		configRequest.getBgpASNumber().equalsIgnoreCase(parentVersion.getInternetLcVrf().getBgpASNumber())&&
				    		configRequest.getRoutingProtocol().equalsIgnoreCase(parentVersion.getInternetLcVrf().getRoutingProtocol())&&
				    		configRequest.getNetworkIp().equalsIgnoreCase(parentVersion.getInternetLcVrf().getNetworkIp())&&
				    		configRequest.getNetworkIp_subnetMask().equalsIgnoreCase(parentVersion.getInternetLcVrf().getNetworkIp_subnetMask())&&
				    		configRequest.getNeighbor1().equalsIgnoreCase(parentVersion.getInternetLcVrf().getNeighbor1())
				    		/*configRequest.getNeighbor2().equalsIgnoreCase(parentVersion.getInternetLcVrf().getNeighbor2())&&
				    		configRequest.getNeighbor2_remoteAS().equalsIgnoreCase(parentVersion.getInternetLcVrf().getNeighbor2_remoteAS())
				    		*/
				    		))
				    		{
				    ...
				    if(!(configRequest.getName().equalsIgnoreCase(parentVersion.getDeviceInterfaceSO().getName()) && 
				    		...
				    		configRequest.getEncapsulation().equalsIgnoreCase(parentVersion.getDeviceInterfaceSO().getEncapsulation())
				    		))
				    		{
				    	key="wanInterface";
				    	getConfigDataforNoCmd(parentVersion, key,counter++);
