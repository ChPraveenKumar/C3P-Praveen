...
public class FirmwareUpgradeForSingleDevice {
	...
	@ResponseBody
	public ResponseEntity addFirmwareUpgradeForSingleDevice(
		...
		try {		
			...
			Map<String, String> success = firmwareInterface
					.addFirmWare(searchParameters);
	...
	@ResponseBody
	public ResponseEntity highestAvailableOsVersionForSingleDevice(
			@RequestBody String searchParameters) {
		...
		try {		
			...
			Map<String, String> success = firmwareInterface
					.findHighestOsVersion(searchParameters);
			...
			{
				obj.put("statusMsg", "A higher version already exists. Are you sure to add you want to add this version ?");
