	...
	public Response search(@RequestBody String searchParameters) {
		...
		try {
			...
			if(field!=null && fieldValue!=null)
			{
				if(field.equalsIgnoreCase("Host name"))
				{
					...
					if(nonMandatoryfiltersbits.equalsIgnoreCase("100"))
					{
						...
						getAllDevice=deviceInforepo.findByDHostNameContainingAndCustSiteIdCCustName(fieldValue, customer);
					}
					if(nonMandatoryfiltersbits.equalsIgnoreCase("110"))
					{
						//find with hostname and customer and region
						getAllDevice=deviceInforepo.findByDHostNameContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegion(fieldValue, customer,region);

					}
					if(nonMandatoryfiltersbits.equalsIgnoreCase("111"))
					{
						//find with hostname and customer and region and site
						getAllDevice=deviceInforepo.findByDHostNameContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegionAndCustSiteIdCSiteName(fieldValue,customer,region,sitetosearch);
				...
				else if(field.equalsIgnoreCase("management ip"))
				{
					...
					if(nonMandatoryfiltersbits.equalsIgnoreCase("100"))
					{
						...
						getAllDevice=deviceInforepo.findByDMgmtIpContainingAndCustSiteIdCCustName(fieldValue, customer);
					}
					if(nonMandatoryfiltersbits.equalsIgnoreCase("110"))
					{
						//find with management ip and customer and region
						getAllDevice=deviceInforepo.findByDMgmtIpContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegion(fieldValue, customer,region);

					}
					if(nonMandatoryfiltersbits.equalsIgnoreCase("111"))
					{
						//find with management ip and customer and region and site
						getAllDevice=deviceInforepo.findByDMgmtIpContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegionAndCustSiteIdCSiteName(fieldValue,customer,region,sitetosearch);
				...
				else if(field.equalsIgnoreCase("os"))
				{
					...
					if(nonMandatoryfiltersbits.equalsIgnoreCase("110"))
					{
						...
						getAllDevice=deviceInforepo.findBydOsContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegion(fieldValue, customer,region);

					}
					if(nonMandatoryfiltersbits.equalsIgnoreCase("111"))
					{
						//find with os and customer and region and site
						getAllDevice=deviceInforepo.findBydOsContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegionAndCustSiteIdCSiteName(fieldValue,customer,region,sitetosearch);
				...
				else if(field.equalsIgnoreCase("os version"))
				{
					...
					if(nonMandatoryfiltersbits.equalsIgnoreCase("100"))
					{
						...
						getAllDevice=deviceInforepo.findBydOsVersionContainingAndCustSiteIdCCustName(fieldValue, customer);
					}
					if(nonMandatoryfiltersbits.equalsIgnoreCase("110"))
					{
						//find with os version and customer and region
						getAllDevice=deviceInforepo.findBydOsVersionContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegion(fieldValue, customer,region);

					}
					if(nonMandatoryfiltersbits.equalsIgnoreCase("111"))
					{
						//find with os version and customer and region and site
						getAllDevice=deviceInforepo.findBydOsVersionContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegionAndCustSiteIdCSiteName(fieldValue,customer,region,sitetosearch);
				...
				else if(field.equalsIgnoreCase("model"))
				{
					...
					if(nonMandatoryfiltersbits.equalsIgnoreCase("100"))
					{
						...
						getAllDevice=deviceInforepo.findByDModelContainingAndCustSiteIdCCustName(fieldValue, customer);
					}
					if(nonMandatoryfiltersbits.equalsIgnoreCase("110"))
					{
						//find with model and customer and region
						getAllDevice=deviceInforepo.findByDModelContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegion(fieldValue, customer,region);

					}
					if(nonMandatoryfiltersbits.equalsIgnoreCase("111"))
					{
						//find with model and customer and region and site
						getAllDevice=deviceInforepo.findByDModelContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegionAndCustSiteIdCSiteName(fieldValue,customer,region,sitetosearch);
				...
				else if(field.equalsIgnoreCase("type"))
				{
					...
					if(nonMandatoryfiltersbits.equalsIgnoreCase("110"))
					{
						...
						getAllDevice=deviceInforepo.findBydTypeContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegion(fieldValue, customer,region);

					}
					if(nonMandatoryfiltersbits.equalsIgnoreCase("111"))
					{
						//find with device type and customer and region and site
						getAllDevice=deviceInforepo.findBydTypeContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegionAndCustSiteIdCSiteName(fieldValue,customer,region,sitetosearch);
				...
				else if(field.equalsIgnoreCase("eol"))
				{
					...
					if(nonMandatoryfiltersbits.equalsIgnoreCase("100"))
					{
						...
						getAllDevice=deviceInforepo.findBydEndOfSaleDateContainingAndCustSiteIdCCustName(fieldValue, customer);
					}
					if(nonMandatoryfiltersbits.equalsIgnoreCase("110"))
					{
						//find with eol and customer and region
						getAllDevice=deviceInforepo.findBydEndOfSaleDateContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegion(fieldValue, customer,region);

					}
					if(nonMandatoryfiltersbits.equalsIgnoreCase("111"))
					{
						//find with eol and customer and region and site
						getAllDevice=deviceInforepo.findBydEndOfSaleDateContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegionAndCustSiteIdCSiteName(fieldValue,customer,region,sitetosearch);
				...
				else if(field.equalsIgnoreCase("eos"))
				{
					...
					if(nonMandatoryfiltersbits.equalsIgnoreCase("100"))
					{
						...
						getAllDevice=deviceInforepo.findBydEndOfSupportDateContainingAndCustSiteIdCCustName(fieldValue, customer);
					}
					if(nonMandatoryfiltersbits.equalsIgnoreCase("110"))
					{
						//find with eos and customer and region
						getAllDevice=deviceInforepo.findBydEndOfSupportDateContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegion(fieldValue, customer,region);

					}
					if(nonMandatoryfiltersbits.equalsIgnoreCase("111"))
					{
						//find with eos and customer and region and site
						getAllDevice=deviceInforepo.findBydEndOfSupportDateContainingAndCustSiteIdCCustNameAndCustSiteIdCSiteRegionAndCustSiteIdCSiteName(fieldValue,customer,region,sitetosearch);
			...
			else
			{
				...
				{
					//find with customer
					getAllDevice=deviceInforepo.findByCustSiteIdCCustNameContaining(customer);
				}
				if(nonMandatoryfiltersbits.equalsIgnoreCase("110"))
				{
					//find with customer and region
					getAllDevice=deviceInforepo.findByCustSiteIdCCustNameContainingAndCustSiteIdCSiteRegionContaining(customer,region);

				}
				if(nonMandatoryfiltersbits.equalsIgnoreCase("111"))
				{
					//find with customer and region and site
					getAllDevice=deviceInforepo.findByCustSiteIdCCustNameContainingAndCustSiteIdCSiteRegionContainingAndCustSiteIdCSiteNameContaining(customer,region,sitetosearch);
