	...
	public class GetCertificationTestData  implements Observer{
		...
		public Response getPrevalidationTestData(@RequestBody String configRequest){
			...
			try{	
			    ...
			    {
			    	dynamicTestArray=dao.getDynamicTestResult(createConfigRequestDCM.getRequestId(),createConfigRequestDCM.getVersion_report(),"Health Check");
			    }
			    else if(createConfigRequestDCM.getTestType().equalsIgnoreCase("networkTest"))
			    {
			    	dynamicTestArray=dao.getDynamicTestResult(createConfigRequestDCM.getRequestId(),createConfigRequestDCM.getVersion_report(),"Network Test");

			    }
			    else if(createConfigRequestDCM.getTestType().equalsIgnoreCase("othersTest"))
			    {
			    	dynamicTestArray=dao.getDynamicTestResult(createConfigRequestDCM.getRequestId(),createConfigRequestDCM.getVersion_report(),"Others");

			    }
			    else if(createConfigRequestDCM.getTestType().equalsIgnoreCase("preValidate"))
			    {
			    	dynamicTestArray=dao.getDynamicTestResult(createConfigRequestDCM.getRequestId(),createConfigRequestDCM.getVersion_report(),"Device Prevalidation");

			    }
			    else if(createConfigRequestDCM.getTestType().equalsIgnoreCase("networkAuditTest"))
			    {
			    	dynamicTestArray=dao.getDynamicTestResult(createConfigRequestDCM.getRequestId(),createConfigRequestDCM.getVersion_report(),"Network Audit");
