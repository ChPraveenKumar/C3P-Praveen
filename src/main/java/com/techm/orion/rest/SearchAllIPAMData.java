		   ...
		   EIPAMEntity dto = gson.fromJson(searchParameters, EIPAMEntity.class);
				...
				
				{
					...
					if (!site.isEmpty() && !customer.isEmpty()) {
						...
						for(int i=0; i<detailsList.size(); i++)
						{
							...
							if(detailsList.get(i).getSite().equals(site) && detailsList.get(i).getCustomer().equals(customer ))
							{  
						...
						for(int i=0; i<detailsList.size(); i++)
						{
							if(detailsList.get(i).getSite().equals(site) && detailsList.get(i).getService().equals(service) )
							{
						...
						for(int i=0; i<detailsList.size(); i++)
						{
							if(detailsList.get(i).getCustomer().equals(customer)&& detailsList.get(i).getService().equals(service) )
							{
						...
						for(int i=0; i<detailsList.size(); i++)
						{
							if(detailsList.get(i).getCustomer().equals(customer) && detailsList.get(i).getIp().equals(ip))
							{
						...
						for(int i=0; i<detailsList.size(); i++)
						{
							if(detailsList.get(i).getService ().equals(service )&& detailsList.get(i).getIp().equals(ip) )
							{
					...
					if (!site.isEmpty() && !customer.isEmpty() && !service.isEmpty()) {
						...
						for(int i=0; i<detailsList.size(); i++)
						{
							if(detailsList.get(i).getSite().equals(site) && detailsList.get(i).getCustomer().equals(customer) && detailsList.get(i).getService().equals(service))
							{  
								
								detailsList = eipamEntityRepository.findBySiteAndCustomerAndService(site, customer, service);
								flag = true;
							}
						}
					}
						...
						for(int i=0; i<detailsList.size(); i++)
						{
							if(detailsList.get(i).getSite().equals(site) && detailsList.get(i).getService().equals(service) && detailsList.get(i).getIp().equals(ip))
							{
						...
						for(int i=0; i<detailsList.size(); i++)
						{
							if(detailsList.get(i).getCustomer().equals(customer) && detailsList.get(i).getService().equals(service) && detailsList.get(i).getIp().equals(ip) )
							{ 
								detailsList = eipamEntityRepository.findByCustomerAndServiceAndIp(customer,service,ip);
								flag = true;
							}
						}
					}
						...
						for(int i=0; i<detailsList.size(); i++)
						{
							if(detailsList.get(i).getSite().equals(site) && detailsList.get(i).getCustomer().equals(customer) && detailsList.get(i).getIp().equals(ip))
							{
			...
			else if (parameters_to_search == 4)
			{
				...
				
				{
					...
					for(int i=0; i<detailsList.size(); i++)
					{
						if(detailsList.get(i).getSite().equals(site) && detailsList.get(i).getCustomer().equals(customer) && detailsList.get(i).getService().equals(service) && detailsList.get(i).getIp().equals(ip) )
						{  
							
							detailsList = eipamEntityRepository.findBySiteAndCustomerAndServiceAndIp(site,customer,service, ip);
							flag = true;
						}
					}
